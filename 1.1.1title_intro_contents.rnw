...
Abstract Title
Chairperson or Co-Chairperson: Committee Member Name
Co-Chairperson: Committee Member Name (remove this line if not applicable)

Abstract Content (Single spaced, one page, two space paragraph indent, no more than 350
words.)
