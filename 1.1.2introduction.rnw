...
\begin{enumerate}
\item{Investigate Quantile Regression as a methodology to predict the full distribution of height growth increments of small ponderosa pine}
\item{Validate the results of this methodology}
\end{enumerate}
