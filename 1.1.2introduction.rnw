...
Partial retention harvesting is an increasingly common option in multiple objective silviculture. Variable retention harvest allows for the removal of merchantable trees while retaining elements of the previous stand's overstory structure. The benefits of the retained trees include improved aesthetic, provision of seed for a new cohort and improved habitat for wildlife. Partial retention harvest is commonly used in ponderosa pine \emph{Pinus ponderosa} stands to facilitate a complex multi-aged stand structure that was historically created through a natural disturbance regime (\cite{Franklin1997}). As a shade-intolerant species, ponderosa pine regeneration responds to the openings in the canopy provided by variable retention harvests (\cite{Aubry2009}). However, the modeling of small ponderosa pine growth dynamics following variable retention harvest requires consideration of complex competitive effects from both the retained overstory and the understory vegetation.
