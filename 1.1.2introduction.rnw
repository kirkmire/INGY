...
\begin{center}
    ...
    \caption[Biological framework of small tree growth.]{Biological framework of small tree growth. Small trees are defined as those that have a DBH less than 3.5 inches.}
    \label{fig:chart}
\end{center}
\end{figure}
