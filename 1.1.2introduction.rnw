...
Variable retention harvesting is an increasingly viable option in multiple objective silviculture. Variable retention harvest allows for the removal of merchantable trees while retaining elements of the previous stand's overstory structure. The benefits of the retained trees include improved aesthetic, providing seed source for a new cohort, improved habitat for wildlife, and have even been proposed as an approach to emulate natural disturbances (\cite{Franklin1997}). The modeling of forest growth dynamics following variable retention harvest requires consideration of competitive effects from both the retained overstory and the understory vegetation.



Ponderosa pine exists in two typical stand structures within silvicultural systems: even-aged and uneven-aged. An even aged stand consists of a cohort of trees at a single age class where most trees cluster near  an average diamter.
Growth in young even-aged ponderosa pine stands is governed primarily by size-density relationships and the site quality. Therefore, density management diagrams (DMS) that incorporate fundemental assumptions about density dependent behavoir of populations can be used used to guide management (James Long). 

Uneven-aged aged stands have high variation in height resulting in an irregular stand profile in the vertical dimension (Peng 2000). As the area of the uneven aged-stand or forest increases, the irregularites tend to even out. The difficulty of modelling forest growth in uneven-aged stands stems from a historical lack of experimental data (Murphy and Farrar, 1883), a lack of temporal reference system (since neither stand age, nor tree age have meaning) and a canonical way to describe the structure of such stands.

Ponderosa pine is an important species both ecologically and commercially in the Inland Northwest. It is a key species in a range of silvicultural systems that vary widely by region and site conditions. Although a full array of silvicultural systems are found applied to ponderosa pine stands in the Northern Rocky Mountains, group selection, seed tree, or shelterwood systems are often recommended (\cite{adams_1994}). In the Pacific Northwest, multiple-entry management using either long-rotation even-aged systems or uneven-aged systems are suggested, with group selection being the most highly recommended (\cite{tesch_1994}). These groups provide openings with sufficient light to allow shade intolerant species to germinate and be competitive in mixed species stands (\cite{O'Hara2005}). The resultant multi-aged stand is suitable for achieving a variety of objectives including timber production, aesthetics, and restoring presettlement stands structures (\cite{O'Hara2005}). Nearly all of the proposed systems include a retained overstory component which is achieved through variable retention harvesting. 


 Powers et al.(\cite{Powers2011a}) found that variable retention harvesting can result in improved seedling photosynthetic capacity, water relations and growth compared to unharvested stands.  The enhanced growth of the small trees on sites without much overstory may be perpetuated throughout the growth of the stand. However, there is limited work examining the factors that affect the developmental responses of the small trees released through variable retention harvests.
...
Regardless of why ponderosa pine growth is suppressed and for how long, this species is remarkably resilient and is fully capable of growth when the suppressing factor is resolved. Ponderosa pine remains physiologically young perpetually and was found to respond to overstory release up to age 200 in Arizona (\cite{barrett_1979}). Stagnated sapling stands in other regions have been found to respond to thinning at ages 70 to 100 years old  and seem to grow as vigorously as unstagnated stands, when crowns grow to sufficient size to occupy the additional growing space (\cite{Van-Deusen1974}). 
...
The description of growth in terms of centiles has been used since the 19th century as a graphical method to monitor height-for-age and weight-for-age trajection of infants and children (\cite{Wei2004},Koenker). Although most of these charts were created through parametric methods (LMS, Cole), recognizing what may be considered out of the ordinary or what the maximum expected growth could be has undoubtedly provided medical practitioners with a useful tool in caring for patients. It has more recently been proven useful in evaluating and predicting other rates of change of biological growth functions near the upper boundary(\cite{Cade2003a}).
