...
xyplot(sinst1$SiteIndex_Value~sinst1$minOSBA,
        xlab="Retained Overstory Basal Area (Basal Area Per acre)",
        col="black",grid=T,
        ylab="Site Index (P.Ponderosa) ft. ht. at 50 yrs.",
       cex.lab=.3,
        main="") 

#add text labels that indicate installation
#only plot initial OSBA measurements
...
\begin{center}
    ...
    \caption{Illustration of a STCV installation and herbicide assignments}
