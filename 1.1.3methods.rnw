...
\begin{figure}[!htb]
\begin{center}
    \includegraphics{quant.reg.ex.jpg}
    \caption{Quantile Regression Visualization. The green, yellow and red surfaces represent the $\tau$= .1, .5 and .9 quantiles, respectively.  \label{fig:quant.reg.ex}}
