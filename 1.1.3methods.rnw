...
Site index from STCV records of each installation's initiation. One or more open grown, undamaged, dominant ponderosa pine site tree was identified at the initiation of the site and site index calculated from standard site index curves for the Inland Northwest (\cite{Milner1992}) with a base age of 50 years at breast height. However, there was a single installation (Grouse Creek) that utilized douglas-fir as the site tree.
...
\begin{center}
    ...
    \caption{Hypothetical seperation of the distribution of annual height increments according to 3 quantile regression surfaces as a function of trees per acre and initial tree height. The green, yellow and red surfaces represent the $\tau$= .1, .5 and .9 quantiles, respectively.\label{fig:quant_reg}}
...
It was also during this stage of preparation that small tree damage codes were screened. Over the years many of the small tagged trees endured some kind of damage including mortality, broken tops, forked tops, sweep or animal damage. Dead trees and those with dead tops were removed from analysis since these trees typically experienced a decrease in height growth from the previous measurement year. See Appendix 3 for the complete list of damage codes recorded. All tree records that exhibited a negative height growth increment were also removed from consideration since this indicated either a measurement error or some misrecorded damage to the top.
