...
%Curtis_lynch
Although several authors mentioned in the introduction found that vegetative competition reduced the height and diameter growth of ponderosa pine (Curtis, Busse, Oliver), we found no suitable measure of vegetative competition that relates to height growth. However, the competitive effect of overstory trees described by (\cite{Oliver1984}, (\cite{Ffolliott1982} and \cite{Moore1992})) was observed in all overstory measures and most pronounced in the measure of trees per acre.
