...
\begin{figure} 
\begin{center}
<<label=capaTpa,fig=TRUE,width=7,height=4,echo=FALSE>>=

library(lattice)

print(xyplot(CCF.OS ~ TPA.OS, data=annual.gr4, groups=InstPlot, type="o",
        xlab="Trees per Acre", 
        ylab=expression("Crown Area Per Acre" ~ (ft^{2}/"acre"))))
...
@
\end{center}
\caption[Comparison of slope, elevation and aspect term to site index]{Examination of relationship between the slope, elevation and aspect interaction term and site index (ft at base age of 50 yrs)\label{fig:sivssea}}
\end{figure}
...
% 
% annual.gr6.lessthan5<-annual.gr6[5<annual.gr6$Height_Total,]
