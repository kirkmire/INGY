...
Figure \ref{fig:sivssea} shows the positive correlation between the SEA value and the site index. The lack of a strong correlation can be attributed to the fact that one site index was obtained for each installation and the SEA value relates productivity to the slope, aspect and elevation at the plot level. Since both of these variables relate to the inherent productivity of the site, it is affirming to see that they positively correlated.
...
Table is related \ref{tab:tree.counts} to Figure \ref{fig:numbRecords} in that it reveals the number of times a unique tree contributed to the model. A nearly equal amount of trees contributed to the model over either one or two measurement intervals. Comparitively few trees appeared three times in the model. Ultimately, the majority of the tree records come from trees that were included over two intervals. Approximately half of that number of trees records were included for only a single measurement interval.
...
@
 \end{center}
 \caption{Initial height (ft) vs. crown ratio.\label{fig:init_ht_cratio}}
 \end{figure}
...
\hline\hline
\multicolumn{1}{c}{Small Tree}&\multicolumn{1}{c}{n}&\multicolumn{1}{c}{AIC}&\multicolumn{1}{c}{Vegetation}&\multicolumn{1}{c}{n}&\multicolumn{1}{c}{AIC}&\multicolumn{1}{c}{Overstory}&\multicolumn{1}{c}{n}&\multicolumn{1}{c}{AIC}\tabularnewline
\hline
Nothing&321&620.4&Nothing&542&683.36&Nothing&2101&1807.31\tabularnewline
SmallTPA&321&501.26&POLV.cov&542&682.1&BAPA&2101&1755.23\tabularnewline
Trees15+&321&551.5&F.cov&542&683.99&CAPA&2101&1662.14\tabularnewline
TGT&321&538.27&LS.cov&542&685.29&TPA&2101&1599.19\tabularnewline
BD&320&401.29&HS.cov&542&685.13&Site&n&AIC\tabularnewline
DBH&287&408.76&F.diff&542&657.12&SI&2101&1367.35\tabularnewline
CrownWidth&321&506.79&LS.diff&542&683.08&Slope&2101&1585.93\tabularnewline
CrownLength&321&468.53&HS.diff&542&678.77&Elevation&2101&1601.07\tabularnewline
CrownRatio&321&384.42&F.tran&542&685.36&Aspect&2101&1598.9\tabularnewline
&&&LS.tran&542&682.66&SEA Int&2101&1295.05\tabularnewline
&&&HS.tran&542&684.85&&&\tabularnewline
&&&G.tran.diff&542&684.92&&&\tabularnewline
&&&G.tran.cov&542&680.96&&&\tabularnewline
&&&mx.vg.diff1m&542&684.86&&&\tabularnewline
&&&mx.vg.diff.tr&542&684.99&&&\tabularnewline
\hline
\end{tabular}\end{center}
\label{tab:AIC}
\end{table}
...
@
\end{center}
\caption{Generalized additive model of annual height growth increment vs. crown ratio with square-root of initial height and crown ratio considered as linear predictors.\label{fig:seqgamOSTPA}}
\end{figure}
...
@
\end{center}
\caption{Annual height increment vs predicted LQMM median height increment\label{fig:qr5resid}}
\end{figure}
...
\begin{tabular}{lrrrr}
\hline\hline
\multicolumn{1}{l}{chisq}&\multicolumn{1}{c}{\textless 4}&\multicolumn{1}{c}{4-6}&\multicolumn{1}{c}{\textgreater 6}&\multicolumn{1}{c}{All}\tabularnewline
\hline
P-Value&$  0$&$ 0.133$&$  0.067$&$  0.052$\tabularnewline
Number of Trees&$109$&$85$&$268$&$462$\tabularnewline
\hline
\end{tabular}\end{center}
\end{table}
...
\begin{tabular}{lrrrr}
\hline\hline
\multicolumn{1}{l}{exp.tab}&\multicolumn{1}{c}{.1-.5}&\multicolumn{1}{c}{.5-.9}&\multicolumn{1}{c}{\textless .1}&\multicolumn{1}{c}{\textgreater .9}\tabularnewline
\hline
\textless 4&$ 43.6$&$ 43.6$&$10.9$&$10.9$\tabularnewline
4-6&$ 34.0$&$ 34.0$&$ 8.5$&$ 8.5$\tabularnewline
\textgreater 6&$107.2$&$107.2$&$26.8$&$26.8$\tabularnewline
\hline
\end{tabular}\end{center}
\end{table}
...
\begin{tabular}{lrrrr}
\hline\hline
\multicolumn{1}{l}{brkdwn}&\multicolumn{1}{c}{.1-.5}&\multicolumn{1}{c}{.5-.9}&\multicolumn{1}{c}{\textless .1}&\multicolumn{1}{c}{\textgreater .9}\tabularnewline
\hline
\textless 4&$ 41$&$43$&$ 2$&$23$\tabularnewline
4-6&$ 42$&$24$&$11$&$ 8$\tabularnewline
\textgreater 6&$105$&$95$&$39$&$29$\tabularnewline
\hline
\end{tabular}\end{center}
\end{table}
