...
Table \ref{tab:tree.counts} is related  to Figure \ref{fig:numbPond} in that it reveals the number of times a unique tree contributed to the model. A nearly equal amount of trees contributed to the model over either one, two or three measurement intervals. Ultimately, the majority of the tree records were from trees that were included over three intervals.
...
% 
% layout(p, title = "Aspect (N) and Elevation (ft)", orientation = -90,margin=list(b=90,r=90))
% 
% @
% \end{center}
