...
\minipage{0.48\textwidth}
  ...
  \caption{GAM of annualized height growth increment vs. initial height.}\label{fig:delta_ht_cratio}
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{cratio_init.png}
  \caption{GAM of annualized height growth increment vs. crown ratio.}\label{fig:init_ht_cratio}
\endminipage\hfill
\end{figure}
...
\minipage{0.32\textwidth}
  ...
  \caption{$\tau$=.1 Residuals}\label{fig:qr1resid}
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{qrsi5resid2.png}
  \caption{$\tau$=.5 Residuals}\label{fig:qr5resid}
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{qrsi9resid2.png}
  \caption{$\tau$=.9 Residuals}\label{fig:qr9resid}
\endminipage
\end{figure}
...
\minipage{0.32\textwidth}
  ...
  \caption{Coefficient Plot of Initial Height}\label{fig:sr_init_coef}
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{cratio_coef.png}
  \caption{Coefficient Plot of Crown Ratio}\label{fig:cr_coef}
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{tpa_coef.png}
  \caption{Coefficient Plot of TPA}\label{fig:os_tpa_coef}
\endminipage
\end{figure}
