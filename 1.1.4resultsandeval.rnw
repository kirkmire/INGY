...
@
 \end{center}
 \caption{Overstory trees per acre by study site, plot and year.\label{fig:os_tpa_inst}}
 \end{figure}
...
\hline
\textbf{cr}&420&580&d_{hs}&721&1005&\textbf{TPA}&2608&2346&\textbf{SEA}&2608&1987\tabularnewline
...
\endminipage\hfill
\caption{Partial residual plots of annualized height growth vs. trees per acre and SEA.}
\end{figure}
