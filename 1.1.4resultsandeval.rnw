...
\begin{figure}
\begin{center}
<<label=polar_plot,fig=TRUE,width=9,height=9,echo=FALSE>>=
library(plotly)
...
@
 \end{center}
 \caption{Histogram of all annualized height growth}
 \end{figure}
...
@
 \end{center}
 \caption{Histogram subject tree total height (in feet) at beginning of period}
 \end{figure}
...
@
 \end{center}
 \caption{Annualized Height Growth of Small Tagged Trees by Installations }
 \end{figure}
...
@
 \end{center}
 \caption{Small trees per acre by installation}
 \end{figure}
...
@
 \end{center}
 \caption{Interpolated Overstory Basal Area}
 \end{figure}
