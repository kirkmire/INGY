...
@
\end{center}
\caption[Comparison of slope, elevation and aspect term to site index]{Partial contribution of slope, elevation and aspect interaction (SEA) to the $\tau$=.5 predicted annual height growth and site index (ft at base age of 50 yrs)\label{fig:sivssea}}
\end{figure}
...
\endminipage\hfill
\caption[Standardized $\tau$=.5 predicted growth increment by slope (\%) and elevation (ft).]{Standardized $\tau$=.5 predicted growth increment by slope (\%) and elevation (ft). The minimum growth was subtracted from the projected growth and divided by the range of growth, thus standardizing the growth increments between 0 and 1. Lighter shades indicate a greater predicted height growth increment.}\label{fig:Sea_heat}
\end{figure}
