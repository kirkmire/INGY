...
@
 \end{center}
 \caption[Species composition of small tree plots in installations with more than 60 tagged ponderosa pine at initiation.]{Species composition of small tree plots in installations with more than 60 tagged ponderosa pine at initiation. PSME= \emph{Psuedotsuga menziesii}, PIPO= \emph{Pinus ponderosa}, ABGR= \emph{Abies grandis}, THPL= \emph{Thuja plicata}, PIMO= \emph{Pinus monticola}, PICO= \emph{Pinus contorta}, LAOC= \emph{Larix occidentalis}.\label{fig:speccomp}}
 \end{figure}
...
\endminipage
\caption{Quantile regression coefficient estimates and 95\% confidence intervals accross $\tau$=1-9.}\label{fig:coefplot}
\end{figure}
...
\endminipage
\caption{Witheld tree height growth increments sorted by predicted height growth increment quantiles intervals and initial height classes.}
\end{figure}
