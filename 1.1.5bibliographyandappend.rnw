...
\begin{equation}\label{eq:finMod}
 \Delta_{\tau} =\textrm{b}_{0,\tau}\sqrt{\textrm{h}}+\textrm{b}_{UT,\tau}\textrm{UT} 
...
Trees per acre overall&trees/ac&tree x interval&SmallTPA\tabularnewline
Trees per acre  \textgreater  15 ft in ht&trees/ac&STP x interval&Trees15+\tabularnewline
Trees per acre above subject tree&trees/ac&tree x interval&TGT\tabularnewline
\hline
...
\newpage
\newappendix{D. Parameter Estimates for Final Models }
