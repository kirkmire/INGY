...
\Sexpr{R.Version()$version.string}. This thesis and bibliography were compiled using the document preparation program \LaTeX\ and bibliography preperation program \hologo{BibTeX}, respectively.
