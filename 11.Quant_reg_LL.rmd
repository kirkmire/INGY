...
LL_both$veg<- ifelse(LL_both$Treatment==LL_veg_2004$Treatment,LL_veg_2004$Coverage,"bad")

if (LL_both$Treatment==LL_veg_2004$Treatment) {
   LL_both$veg<-LL_veg_2004$Coverage
}
