...
LL_init<-length(LL1[LL1$Year_Measurement=="1999",])
...
lllp<-ggplot(data=LL1_both, aes(x=Year_Measurement, y=inc,color=LL1_both$Height_Total.x))+geom_point()+
...
lllp+scale_colour_gradient(limits=c(-1, 15), low="red", high="green")
