...
# get the LL data
LF1 <- get.interval("LF",2002,2006)
LF2 <- get.interval("LF",2006,2010)
LF3 <- get.interval("LF",2010,2014)

# combine
LF <- rbind(LF1,LF2,LF3)

# plot
xyplot(ht.inc ~ init.ht | Species, data=LF, groups=yr1,
