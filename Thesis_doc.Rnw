...
\begin{figure}
\begin{center}
<<label=sampleplot,fig=TRUE,width=8,height=8,echo=FALSE>>=
library(plotrix)
...
rect(80,47,(80+3.28084),(47+3.28084),col=NA,border="black", lwd=1)
...
\begin{figure}[h]
\begin{center}
<<label=species, fig=TRUE,width=5,height=5,echo=FALSE>>=
